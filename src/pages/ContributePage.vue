						...
						<div class="text-center">
							...
							<div class="flex flex-col gap-4">
								...
								>
									...
									>
										<path
											d="M23.638 14.904c-1.602 6.43-8.113 10.34-14.542 8.736C2.67 22.037-1.22 15.525.384 9.096 1.987 2.667 8.498-1.243 14.927.362c6.43 1.605 10.34 8.116 8.736 14.542h-2.076V14.9l-.038.004zm-6.22-3.607c.385-1.543 1.876-2.26 3.42-1.876 1.544.385 2.26 1.876 1.876 3.42-.385 1.544-1.876 2.26-3.42 1.876-1.544-.385-2.26-1.876-1.876-3.42zm2.543 3.42c.77.192 1.53-.192 1.73-.963.192-.77-.192-1.53-.963-1.73-.77-.192-1.53.192-1.73.963-.192.77.192 1.53.963 1.73zm-1.73-3.42c.192.77.77 1.147 1.538.955.77-.192 1.147-.77.955-1.538-.192-.77-.77-1.147-1.538-.955-.77.192-1.147.77-.955 1.538zM12 3.46l-1.077 3.846H7.154l2.846 2.077L8.923 15.23 12 12.384l3.077 2.846-1.077-5.846 2.846-2.077h-3.77L12 3.46z"
										/>
									</svg>
									BTC Wallet
								</button>
